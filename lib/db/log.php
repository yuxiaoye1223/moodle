...
$logs = array(
    array('module'=>'user', 'action'=>'view', 'mtable'=>'user', 'field'=>fullname_sql()),
    array('module'=>'course', 'action'=>'user report', 'mtable'=>'user', 'field'=>fullname_sql()),
    ...
    array('module'=>'message', 'action'=>'write', 'mtable'=>'user', 'field'=>fullname_sql()),
    array('module'=>'message', 'action'=>'read', 'mtable'=>'user', 'field'=>fullname_sql()),
    array('module'=>'message', 'action'=>'add contact', 'mtable'=>'user', 'field'=>fullname_sql()),
    array('module'=>'message', 'action'=>'remove contact', 'mtable'=>'user', 'field'=>fullname_sql()),
    array('module'=>'message', 'action'=>'block contact', 'mtable'=>'user', 'field'=>fullname_sql()),
